...
//This holds name Joe, age Schmoe and hometown 100
// 2. What is "this" when joe.scopeArrow() is invoked?
// It simply returns the sturcture of the object
// 3. Explain why "this" is different when an arrow function is used.
// It has no scope of this and therefore has no context for waht this would be and this becomes a globally scoped reference referring to the window
